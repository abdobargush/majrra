					...
					<form method="POST" action="{{ route('register') }}">
						...
						<div class="form-group">
							...
							<input name="username" id="username" type="text" 
								...
								data-validate="register-username" minlength="3" maxlength="32" required autofocus>

							@error('username')
								<label for="username" class="error" role="alert">
						...
						<div class="form-group">
							...
							<input name="email" id="email" type="email" 
								...
								data-validate="register-email" required autocomplete="email">
