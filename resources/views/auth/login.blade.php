            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <a href="{{ route('socialAuth', 'twitter') }}" class="btn btn-twitter btn-block">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input name="email" id="email" type="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" autocomplete="email" required autofocus>
                        </div>
                        ...
                        <div class="form-group text-center">
                            <a href="{{ route('password.request') }}" class="mb-2 text-center">
