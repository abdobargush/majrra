...
class PageCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setEntityNameStrings( __('Page'), __('Pages'));
    }
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::column('slug');
        CRUD::column('updated_at')->label(__('Updated'));
    }
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('slug');
        CRUD::field('content')->type('wysiwyg')->label(__('Content'));
    }
	...
	protected function setupShowOperation()
	{
		CRUD::column('title')->label(__('Title'));
        CRUD::column('slug');
        CRUD::column('content')->type('markdown')->label(__('Content'));
